export default {
  ...
  frontpage: {
    ...
    tests_taken: 'มีผู้เข้าร่วมการทดสอบมากกว่า 700,000 คน',
    compare: {
    ...
    cards: {
      ...
      translated: {
        title: 'แปลภาษา',
        text: 'ได้รับการแปลเป็นภาษาต่างๆมากกว่า 20 '
      }
    },
    description: {
      top: 'ทำความรู้จักตัวเองให้ดีขึ้นด้วยแบบทดสอบบุคลิกภาพฟรีและเป็นที่ยอมรับในระดับสากล',
      subtop: 'นี่',
...
ชุดวัดบุคลิกภาพจาก <i>Johnson's (2014) 120-item IPIP NEO-PI-R</i>.`,
      info: 'การทดสอบต่อไปนี้ประกอบด้วยคำถาม 120 ข้อซึ่งคาดว่าจะใช้เวลาประมาณ 10 นาทีในการทำ',
