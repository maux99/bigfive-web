export default {
  ...
  */
  head: {
    titleTemplate: 'Big Five personality traits test',
    ...
    meta: [
      ...
      { hid: 'og:title', name: 'og:title', content: 'Big Five personality traits test' },
      ...
      { hid: 'twitter:title', name: 'twitter:title', content: 'Big Five personality traits test' },
